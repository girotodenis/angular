...
export class AppComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    console.log("iniciando config app")
    
    /*
    * Define comportamento apos o login
    * */
   this.eventService.registraAcao("app_autenticacao", "pos_login", "ConfigAppService", () => {
      console.log("envia tela incial")
     ...
     * ação do logout
     */
    this.eventService.registraAcao("app_autenticacao", "logout", "ConfigAppService", () => {
